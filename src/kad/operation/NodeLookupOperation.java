...
import kad.KadConfiguration;
import kad.KadServer;
import kad.KademliaNode;
import kad.exceptions.RoutingException;
import kad.message.Message;
import kad.message.NodeLookupMessage;
import kad.message.NodeReplyMessage;
import kad.message.Receiver;
import kad.node.KademliaId;
import kad.node.KeyComparator;
import kad.node.Node;
import kad.node.XORComparator;
...
public class NodeLookupOperation implements Operation, Receiver
{
    ...
    public NodeLookupOperation(KadServer server, KademliaNode localNode, KademliaId lookupId, KadConfiguration config)
    {
         ...
         */
        this.comparator = new XORComparator(lookupId);
    ...
    private boolean askNodesorFinish() throws IOException
    {
         ...
         * making sure that no more than CONCURRENCY messsages are in transit
         */
